...
const teamNameToDataMap = {
  ...
  Halloween: {name: "Halloween", colors: [ "Orange", "Black"], mascot: "Halloween", cheers: ["Halloween!"], imageNames:["pumpkin.png", "ghost.png"]},
  ...
  Rainbow: {name: "Rainbow", colors: [ "Dark Red", "Red", "Orange Red", "Orange", "Yellow",
             "Chartreuse", "Green", "Blue", "Indigo", "Violet"], cheers: [], imageNames:["rainbow.png"]},
  ...
  Santa: {name: "Santa", colors: [ "Red", "White"], mascot: "Santa", cheers: ["Go Santa!"], imageNames:["santa.png"]},
  Snow: {name: "Snow", colors: [ "Snow"], mascot: "Snow", cheers: ["Snow!"], imageNames:["snowflake.png"]},
  Snowman: {name: "Snowman", colors: [ "Snow"], mascot: "Snowman", cheers: ["Snowman!"], imageNames:["snowman.png"]},
  Tree: {name: "Tree", colors: [ "Green"], mascot: "Tree", cheers: ["Tree!"], imageNames:["christmas tree.png"]},
