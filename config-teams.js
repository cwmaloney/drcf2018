...
const teamNameToDataMap = {
  ...
  Halloween: {name: "Halloween", colors: [ "Orange", "Black"], mascot: "Halloween", cheers: ["Yeah Halloween!"]},
  ...
  Rainbow: {name: "Rainbow", colors: [ "Dark Red", "Red", "Orange Red", "Orange", "Yellow",
             "Chartreuse", "Green", "Blue", "Indigo", "Violet"], /*mascot: "", */ cheers: []},
  ...
  Santa: {name: "Santa", colors: [ "Red", "White"], mascot: "Santa", cheers: ["Go Santa!"]},
  Snow: {name: "Snow", colors: [ "Snow"], mascot: "Snow", cheers: ["Go Snow!"]},
