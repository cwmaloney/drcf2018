...
class CheerScene {
  ...
  showTeamAnimation(){
    ...
    const font16 = new Font("*default*", 18, colors[0]);
  ...
  showColorWords(){
    ...
    if (this.currentCheer.sender != null && this.currentCheer.sender != "") {
      const font11 = new Font("*default*", 12, new Color(255, 255, 255));
    ...
    let length = 0;
    let font = new Font("*default*", 18, new Color(255, 255, 255));
    ...
    for (let i = 0; i < this.currentCheer.colorNames.length && i < 10; ++i) {
      font = new Font("*default*", 18, Color.fromRgb(colorNameToRgb[this.currentCheer.colorNames[i]]));
  ...
  showColorTrees(){
    ...
    let y = 6;
    if (this.currentCheer.sender != null && this.currentCheer.sender != "") {
      const font12 = new Font("*default*", 12, new Color(255, 255, 255));
      frameBuffer.print1Line(this.currentCheer.sender + " cheers for:", font12, 0);
      this.gridzilla.transformScreen(frameBuffer);
      y = 12;
    }
